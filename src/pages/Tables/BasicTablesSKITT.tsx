...
import BasicTableSKITT from "../../components/tables/BasicTables/BasicTableSKITT";
...
export default function BasicTables() {
  ...
  const handleSubmitAjukan = async (e: any) => {
    ...
    if (!formData.fasilitas_kesehatan) newErrors.fasilitas_kesehatan = "Fasilitas kesehatan yang anda gunakan wajib diisi";
    ...
    Object.entries(formData).forEach(([key, val]) => {
      ...
      const res = await axios.post(
        "http://127.0.0.1:8000/api/masyarakat/skitt/",
        payload,
        {
          headers: {
      ...
      setAlertData({
        variant: "success",
        title: "Berhasil",
        message: res.data?.message || "Pengajuan Surat Pengantar RT dan Surat Keterangan Imunisasi TT berhasil dikirim!",
      });
      ...
      setTimeout(() => {
        localStorage.setItem(
          ...
          JSON.stringify({
            variant: "success",
            title: "Berhasil",
            message: res.data?.message || "Pengajuan Surat Keterangan Imunisasi TT berhasil dikirim!",
          })
        );
  ...
  const handleExportSubmit = async (e: any) => {
    ...
    try {
      const res = await axios.post(
        "http://127.0.0.1:8000/api/perangkat_desa/skitt/export",
        {
      ...
      variant: "success",
      title: "Berhasil",
      message: "Data Surat Keterangan Imunisasi TT berhasil diexport.",
    };
  ...
  const handleDeleteSubmit = async (e: any) => {
    ...
    try {
      const res = await axios.delete(
        "http://127.0.0.1:8000/api/perangkat_desa/skitt/delete-all",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      variant: "success",
      title: "Berhasil",
      message: res.data?.message || "Semua data Surat Keterangan Imunisasi TT berhasil dihapus.",
    };
  ...
  return (
    <>
      <PageMeta title="Ajuan Surat Keterangan Imunisasi TT" description="Halaman riwayat ajuan Surat Keterangan Imunisasi TT" />
      <PageBreadcrumb pageTitle="Layanan Ajuan Surat Keterangan Imunisasi TT (Tetanus Toksoid)" />
        ...
        <div className="relative flex flex-col w-full max-h-[90vh] overflow-hidden rounded-3xl bg-white dark:bg-gray-900 shadow-xl">
          ...
          <div className="px-6 pt-8 pb-4 lg:px-11 lg:pt-11">
            <h4 className="mb-2 text-2xl font-bold text-gray-800 dark:text-white/90">
              Form Ajuan Surat Keterangan Imunisasi TT
            </h4>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Isi data lengkap pengajuan Surat Keterangan Imunisasi TT sebelum dikirim.
            </p>
          </div>
            ...
            <div className="custom-scrollbar flex-grow overflow-y-auto px-6 pb-6 lg:px-11">
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                ...
                <div className="lg:col-span-2 space-y-2">
                 ...
                 {/* ALASAN PERMOHONAN */}
                <div className="lg:col-span-2 space-y-2">
                  <Label>Alasan Permohonan <span className="text-red-500 text-[10px]">*alasan anda mengajukan Surat Keterangan Imunisasi TT</span></Label>
                  <Textarea
                    name="alasan"
                    value={formData.alasan}
                    onChange={handleChange}
                    placeholder="Contoh: Syarat pekerjaan, sekolah, dll."
                  />
                ...
                {/* Fasilitas Kesehatan */}
                <div className="lg:col-span-2 space-y-2">
                  <Label>Nama Fasilitas Kesehatan yang anda gunakan <span className="text-red-500">*</span></Label>
                  <Textarea
                    name="fasilitas_kesehatan"
                    value={formData.fasilitas_kesehatan}
                    onChange={handleChange}
                    placeholder="Contoh: Puskesmas Mejayan...."
                  />
                  {errors.fasilitas_kesehatan && <p className="text-xs text-red-500">{errors.fasilitas_kesehatan}</p>}
                </div>

                {/* KEPERLUAN */}
                <div className="lg:col-span-2 space-y-2">
                  <Label>Keperluan <span className="text-red-500 text-[10px]">*untuk mengisi surat pengantar dari RT</span></Label>
                  <Textarea
                    name="keperluan"
                    value={formData.keperluan}
                    onChange={handleChange}
                    placeholder="Contoh: Untuk mengajukan Surat Keterangan Imunisasi TT"
                  />
                ...
                <div className="lg:col-span-2 space-y-2">
                  ...
                  <Select
                    ...
                    searchable
                  />{errors.rt_id && <p className="text-xs text-red-500">{errors.rt_id}</p>}
                </div>
      ...
      >
        <div className="relative w-full rounded-3xl bg-white p-6 dark:bg-gray-900">
          ...
          <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
            Export Data Surat Keterangan Imunisasi TT
          </h4>
          ...
          <form onSubmit={handleExportSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="contoh: data-Surat Keterangan Imunisasi TT-januari"
              />
        ...
        <div className="relative w-full max-w-[700px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
          ...
          <div className="mb-4">
            <h4 className="text-2xl font-semibold text-gray-800 dark:text-white/90">
              Tata Cara Pengajuan Layanan Ajuan Surat Keterangan Imunisasi TT
            </h4>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Panduan singkat pengajuan Surat Keterangan Imunisasi TT
            </p>
          </div>
          ...
          <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
             <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>Isi seluruh form pengajuan Surat Keterangan Imunisasi TT dengan lengkap.</li>
              ...
              <li>Isi kolom alasan untuk surat alasan anda mengajukan Surat Keterangan Imunisasi TT.</li>
      ...
      >
        <div className="relative w-full rounded-3xl bg-white p-6 dark:bg-gray-900">
          ...
          <h4 className="mb-4 text-2xl font-semibold text-red-600">
            Hapus Semua Data Surat Keterangan Imunisasi TT
          </h4>

          <p className="mb-6 text-sm text-gray-500">
            Masukkan password akun Anda untuk menghapus <b>SEMUA</b> data Surat Keterangan Imunisasi TT.
