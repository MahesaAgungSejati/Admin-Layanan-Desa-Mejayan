...
import TableDataPerangkatDesa from "../../components/tables/BasicTables/TableDataPerangkatDesa";
...
export default function TablesDataPerangkatDesa() {
  // ================= ALERT =================
type AlertType = {
...
const role = user?.role;
  ...
  // ================= ADD Perangkat Desa =================
const handleAddPerangkatDesa = async (e: React.FormEvent) => {
  e.preventDefault();
  ...
  try {
    ...
    await axios.post(
      "http://localhost:8000/api/users/add-perangkat-desa",
      formAdd,
      {
        headers: {
  ...
  return (
    <>
      ...
      />
      <PageBreadcrumb pageTitle="Data Perangkat Desa" />
          ...
          <div className="flex flex-col gap-5 mb-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Kelola data Perangkat Desa Mejayan.
              </p>
            </div>
...
{role === "super_admin" && (
  ...
  >
    ...
    <span className="font-medium">Tambah Perangkat Desa</span>
  </Button>
)}
        ...
        <div className="relative flex flex-col w-full max-h-[90vh] overflow-hidden rounded-3xl bg-white dark:bg-gray-900 shadow-xl">
          ...
          <div className="px-6 pt-8 pb-4 lg:px-11 lg:pt-11">
            <h4 className="mb-2 text-2xl font-bold text-gray-800 dark:text-white/90">
              Tambah PerangkatDesa
            </h4>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Masukkan data Perangkat Desa.
            </p>
          </div>

          {/* FORM */}
        <form
          onSubmit={handleAddPerangkatDesa}
          ...
          <div className="custom-scrollbar flex-grow overflow-y-auto px-6 pb-6 lg:px-11">
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  type="email"
                  placeholder="contoh: pr06@gmail.com"
                  value={formAdd.email}
                  onChange={(e) =>
