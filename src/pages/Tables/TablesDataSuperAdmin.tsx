...
import TableDataSuperAdmin from "../../components/tables/BasicTables/TableDataSuperAdmin";
...
export default function TablesDataSuperAdmin() {
  // ================= ALERT =================
type AlertType = {
...
const handleAddSuperAdmin = async (e: React.FormEvent) => {
  ...
  try {
    ...
    await axios.post(
      "http://localhost:8000/api/users/add-super-admin",
      formAdd,
      {
        headers: {
  ...
  return (
    <>
      <PageMeta
        ...
        description="Kelola data Super Admin"
      />
      <PageBreadcrumb pageTitle="Data Super Admin" />
          ...
          <div className="flex flex-col gap-5 mb-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Kelola data Super Admin Mejayan.
              </p>
            </div>
...
{role === "super_admin" && (
  ...
  >
    ...
    <span className="font-medium">Tambah Super Admin</span>
  </Button>
)}
          ...
          <div className="custom-scrollbar flex-grow overflow-y-auto px-6 pb-6 lg:px-11">
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="Masukkan nama Super Admin"
                  value={formAdd.nama}
                  onChange={(e) =>
