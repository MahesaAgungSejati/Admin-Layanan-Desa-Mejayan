...
import TableDataKepalaDesa from "../../components/tables/BasicTables/TableDataKepalaDesa";
...
export default function TablesDataKepalaDesa() {
  // ================= ALERT =================
type AlertType = {
...
// ================= ADD Kepala Desa =================
const handleAddKepalaDesa = async (e: React.FormEvent) => {
  e.preventDefault();
  ...
  try {
    ...
    await axios.post(
      "http://localhost:8000/api/users/add-kepala-desa",
      formAdd,
      {
        headers: {
  ...
  return (
    <>
      <PageMeta
        ...
        description="Kelola data Kepala Desa"
      />
      <PageBreadcrumb pageTitle="Data Kepala Desa" />
          ...
          <div className="flex flex-col gap-5 mb-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-xl font-medium text-gray-800 dark:text-white/90">
                Tabel Data Kepala Desa
              </h2>
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Kelola data Kepala Desa Mejayan.
              </p>
            </div>
...
{role === "super_admin" && (
  ...
  >
    ...
    <span className="font-medium">Tambah Kepala Desa</span>
  </Button>
)}
        ...
        <div className="relative flex flex-col w-full max-h-[90vh] overflow-hidden rounded-3xl bg-white dark:bg-gray-900 shadow-xl">
          ...
          <div className="px-6 pt-8 pb-4 lg:px-11 lg:pt-11">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Masukkan data Kepala Desa.
            </p>
          </div>

          {/* FORM */}
        <form
          onSubmit={handleAddKepalaDesa}
          ...
          <div className="custom-scrollbar flex-grow overflow-y-auto px-6 pb-6 lg:px-11">
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  type="email"
                  placeholder="contoh: kd06@gmail.com"
                  value={formAdd.email}
                  onChange={(e) =>
