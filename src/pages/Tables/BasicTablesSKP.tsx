...
import BasicTableSKP from "../../components/tables/BasicTables/BasicTableSKP";
...
export default function BasicTables() {
  ...
  const handleSubmitAjukan = async (e: any) => {
    ...
    Object.entries(formData).forEach(([key, val]) => {
      ...
      const res = await axios.post(
        "http://127.0.0.1:8000/api/masyarakat/skp/",
        payload,
        {
          headers: {
      ...
      setAlertData({
        variant: "success",
        title: "Berhasil",
        message: res.data?.message || "Pengajuan Surat Pengantar RT dan Surat Keterangan Penduduk berhasil dikirim!",
      });
      ...
      setTimeout(() => {
        localStorage.setItem(
          ...
          JSON.stringify({
            variant: "success",
            title: "Berhasil",
            message: res.data?.message || "Pengajuan Surat Keterangan Penduduk berhasil dikirim!",
          })
        );
  ...
  const handleExportSubmit = async (e: any) => {
    ...
    try {
      const res = await axios.post(
        "http://127.0.0.1:8000/api/perangkat_desa/skp/export",
        {
      ...
      variant: "success",
      title: "Berhasil",
      message: "Data Surat Keterangan Penduduk berhasil diexport.",
    };
  ...
  const handleDeleteSubmit = async (e: any) => {
    ...
    try {
      const res = await axios.delete(
        "http://127.0.0.1:8000/api/perangkat_desa/skp/delete-all",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      variant: "success",
      title: "Berhasil",
      message: res.data?.message || "Semua data Surat Keterangan Penduduk berhasil dihapus.",
    };
  ...
  return (
    <>
      <PageMeta title="Ajuan Surat Keterangan Penduduk" description="Halaman riwayat ajuan Surat Keterangan Penduduk" />
      <PageBreadcrumb pageTitle="Layanan Ajuan Surat Keterangan Penduduk" />
        ...
        <div className="relative flex flex-col w-full max-h-[90vh] overflow-hidden rounded-3xl bg-white dark:bg-gray-900 shadow-xl">
          ...
          <div className="px-6 pt-8 pb-4 lg:px-11 lg:pt-11">
            <h4 className="mb-2 text-2xl font-bold text-gray-800 dark:text-white/90">
              Form Ajuan Surat Keterangan Penduduk
            </h4>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Isi data lengkap pengajuan Surat Keterangan Penduduk sebelum dikirim.
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
               ...
               {/* STATUS PERKAWINAN */}
                ...
                <div className="lg:col-span-2 space-y-2">
                 ...
                 {/* ALASAN PERMOHONAN */}
                <div className="lg:col-span-2 space-y-2">
                  <Label>Alasan Permohonan <span className="text-red-500 text-[10px]">*alasan anda mengajukan Surat Keterangan Penduduk</span></Label>
                  <Textarea
                    name="alasan"
                    value={formData.alasan}
                    onChange={handleChange}
                    placeholder="Contoh: Syarat beasiswa, bantuan, dll."
                  />
                ...
                <div className="lg:col-span-2 space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={handleChange}
                    placeholder="Contoh: Untuk mengajukan Surat Keterangan Penduduk"
                  />
      ...
      >
        <div className="relative w-full rounded-3xl bg-white p-6 dark:bg-gray-900">
          ...
          <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
            Export Data Surat Keterangan Penduduk
          </h4>
          ...
          <form onSubmit={handleExportSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="contoh: data-Surat Keterangan Penduduk-januari"
              />
        ...
        <div className="relative w-full max-w-[700px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
          ...
          <div className="mb-4">
            <h4 className="text-2xl font-semibold text-gray-800 dark:text-white/90">
              Tata Cara Pengajuan Surat Keterangan Penduduk
            </h4>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Panduan singkat pengajuan Surat Keterangan Penduduk
            </p>
          </div>
          ...
          <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <li>Isi seluruh form pengajuan Surat Keterangan Penduduk dengan lengkap.</li>
              ...
              <li>Isi kolom alasan untuk surat alasan anda mengajukan Surat Keterangan Penduduk.</li>
      ...
      >
        <div className="relative w-full rounded-3xl bg-white p-6 dark:bg-gray-900">
          ...
          <h4 className="mb-4 text-2xl font-semibold text-red-600">
            Hapus Semua Data Surat Keterangan Penduduk
          </h4>

          <p className="mb-6 text-sm text-gray-500">
            Masukkan password akun Anda untuk menghapus <b>SEMUA</b> data Surat Keterangan Penduduk.
