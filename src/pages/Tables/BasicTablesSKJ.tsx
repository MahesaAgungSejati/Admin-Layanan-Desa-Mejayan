...
import BasicTableSKJ from "../../components/tables/BasicTables/BasicTableSKJ";
...
export default function BasicTables() {
  ...
  const handleSubmitAjukan = async (e: any) => {
    ...
    if (!formData.nama_mantan_suami) newErrors.nama_mantan_suami = "Nama mantan suami wajib diisi";
    ...
    Object.entries(formData).forEach(([key, val]) => {
      ...
      const res = await axios.post(
        "http://127.0.0.1:8000/api/masyarakat/skj/",
        payload,
        {
          headers: {
      ...
      setAlertData({
        variant: "success",
        title: "Berhasil",
        message: res.data?.message || "Pengajuan Surat Pengantar RT dan Surat Keterangan Janda berhasil dikirim!",
      });
      ...
      setTimeout(() => {
        localStorage.setItem(
          ...
          JSON.stringify({
            variant: "success",
            title: "Berhasil",
            message: res.data?.message || "Pengajuan Surat keterangan janda berhasil dikirim!",
          })
        );
  ...
  const handleExportSubmit = async (e: any) => {
    ...
    try {
      const res = await axios.post(
        "http://127.0.0.1:8000/api/perangkat_desa/skj/export",
        {
      ...
      variant: "success",
      title: "Berhasil",
      message: "Data Surat Keterangan Janda berhasil diexport.",
    };
  ...
  const handleDeleteSubmit = async (e: any) => {
    ...
    try {
      const res = await axios.delete(
        "http://127.0.0.1:8000/api/perangkat_desa/skj/delete-all",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      variant: "success",
      title: "Berhasil",
      message: res.data?.message || "Semua data Surat Keterangan Janda berhasil dihapus.",
    };
  ...
  return (
    <>
      <PageMeta title="Ajuan Surat Keterangan Janda" description="Halaman riwayat ajuan Surat Keterangan Janda" />
      <PageBreadcrumb pageTitle="Layanan Ajuan Surat Keterangan Janda" />
        ...
        <div className="relative flex flex-col w-full max-h-[90vh] overflow-hidden rounded-3xl bg-white dark:bg-gray-900 shadow-xl">
          ...
          <div className="px-6 pt-8 pb-4 lg:px-11 lg:pt-11">
            <h4 className="mb-2 text-2xl font-bold text-gray-800 dark:text-white/90">
              Form Ajuan Surat Keterangan Janda
            </h4>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Isi data lengkap pengajuan Surat Keterangan Janda sebelum dikirim.
            </p>
          </div>
              ...
              {/* STATUS PERKAWINAN */}
               ...
               {/* PENDIDIKAN */}
                ...
                <div className="lg:col-span-2 space-y-2">
                 ...
                 <div className="lg:col-span-2 space-y-2">
                  <Label>Nama Mantan Suami <span className="text-red-500">*</span></Label>
                  <Input
                    name="nama_mantan_suami"
                    value={formData.nama_mantan_suami}
                    onChange={handleChange}
                    placeholder="Masukkan nama mantan suami anda"
                  />
                  {errors.nama_mantan_suami && <p className="text-xs text-red-500">{errors.nama_mantan_suami}</p>}
                </div>
                ...
                <div className="lg:col-span-2 space-y-2">
                 ...
                 {/* ALASAN PERMOHONAN */}
                <div className="lg:col-span-2 space-y-2">
                  <Label>Alasan Permohonan <span className="text-red-500 text-[10px]">*alasan anda mengajukan Surat Keterangan Janda</span></Label>
                  <Textarea
                    name="alasan"
                    value={formData.alasan}
                    onChange={handleChange}
                    placeholder="Contoh: Syarat tunjangan, menikah lagi, dll."
                  />
                ...
                <div className="lg:col-span-2 space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={handleChange}
                    placeholder="Contoh: Untuk mengajukan Surat Keterangan Janda"
                  />
                ...
                {/* PILIH RT */}
                <div className="lg:col-span-2 space-y-2">
                  <Label>Pilih Ketua RT <span className="text-red-500">*</span></Label>
                  <Select
                    options={rtOptions}
      ...
      >
        <div className="relative w-full rounded-3xl bg-white p-6 dark:bg-gray-900">
          ...
          <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
            Export Data Surat Keterangan Janda
          </h4>
          ...
          <form onSubmit={handleExportSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="contoh: data-Surat Keterangan Janda-januari"
              />
        ...
        <div className="relative w-full max-w-[700px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
          ...
          <div className="mb-4">
            <h4 className="text-2xl font-semibold text-gray-800 dark:text-white/90">
              Tata Cara Pengajuan Surat Keterangan Janda
            </h4>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Panduan singkat pengajuan Surat Keterangan Janda
            </p>
          </div>
          ...
          <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>Isi seluruh form pengajuan Surat Keterangan Janda dengan lengkap.</li>
              ...
              <li>Isi kolom alasan untuk surat alasan anda mengajukan surat keterangan janda.</li>
      ...
      >
        <div className="relative w-full rounded-3xl bg-white p-6 dark:bg-gray-900">
          ...
          <h4 className="mb-4 text-2xl font-semibold text-red-600">
            Hapus Semua Data Surat Keterangan Janda
          </h4>

          <p className="mb-6 text-sm text-gray-500">
            Masukkan password akun Anda untuk menghapus <b>SEMUA</b> data Surat Keterangan Janda.
