...
interface ModalDetailDataKepalaDesaProps {
  isOpen: boolean;
  onClose: () => void;
  data: KepalaDesaDetail | null;
}

export default function ModalDetailDataKepalaDesa({
  isOpen,
  onClose,
  data,
}: ModalDetailDataKepalaDesaProps) {
  if (!data) return null;
      ...
      <div className="relative w-full p-6 bg-white rounded-2xl dark:bg-gray-900 shadow-2xl">
        ...
        <div className="mb-4 border-b pb-3 dark:border-gray-700">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Informasi lengkap data Kepala Desa
          </p>
        </div>
