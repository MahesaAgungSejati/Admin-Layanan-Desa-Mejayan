...
export default function ModalFormMasyarakat({
  isOpen,
  closeModal,
  formData,
  handleInputChange,
      ...
      <div className="custom-scrollbar flex-grow overflow-y-auto px-6 pb-6 lg:px-11">
        ...
        <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Input name="email" value={formData.email} disabled className="bg-gray-50 opacity-70" />
          </div>

          {/* NIK - DISABLED */}
          <div className="space-y-2">
            <Label>NIK <span className="text-red-500 text-[10px]">*hubungi admin untuk merubah</span></Label>
            <Input name="nik" value={formData.nik} disabled className="bg-gray-50 opacity-70" />
          </div>
