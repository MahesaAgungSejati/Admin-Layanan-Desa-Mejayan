...
interface ModalDetailDataKetuaRTProps {
  isOpen: boolean;
  onClose: () => void;
  data: KetuaRTDetail | null;
}

export default function ModalDetailDataKetuaRT({
  isOpen,
  onClose,
  data,
}: ModalDetailDataKetuaRTProps) {
  if (!data) return null;
      ...
      <div className="relative w-full p-6 bg-white rounded-2xl dark:bg-gray-900 shadow-2xl">
        ...
        <div className="mb-4 border-b pb-3 dark:border-gray-700">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Informasi lengkap data Ketua RT
          </p>
        </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
                {[
                  ...
                  { label: "Nomor RT", value: `RT ${data.no_rt}` },
