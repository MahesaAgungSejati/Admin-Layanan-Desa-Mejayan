...
interface ModalDetailDataPerangkatDesaProps {
  isOpen: boolean;
  onClose: () => void;
  data: PerangkatDesaDetail | null;
}

export default function ModalDetailDataPerangkatDesa({
  isOpen,
  onClose,
  data,
}: ModalDetailDataPerangkatDesaProps) {
  if (!data) return null;
      ...
      <div className="relative w-full p-6 bg-white rounded-2xl dark:bg-gray-900 shadow-2xl">
        ...
        <div className="mb-4 border-b pb-3 dark:border-gray-700">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Informasi lengkap data Perangkat Desa
          </p>
        </div>
